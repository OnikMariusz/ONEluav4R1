local FuncModule = require("DungeonGenerator/helpFunctions")
local TileModule = require("DungeonGenerator/Tile")
local RoomModule = require("DungeonGenerator/Room")
...
function Level:printLevel ()
	...
	local file = assert(io.open("DungeonGenerator/dungeon.txt", "a+"))
	file:write("start")
	file:write("\n")
